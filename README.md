...
当用户结束回顾后，从“最近回顾”再次选择“重点回顾”时，系统会先把历史错题、低分内容方面、focusSubpoint、错误点、遗漏点和判断策略按内容方面与子点分组抽样，再由模型归纳真正的薄弱概念、优先级、targetSubpoints、misconceptions 和出题策略，最后据此重新生成重点题库。
